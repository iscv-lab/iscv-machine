...
from tools.big_five.myutils.model_function import (
    format_3d_landmarks_by_frame,
    compute_data_features,
)
from tools.big_five.myutils.landmarks_processing import (
    translate_face_to_origin,
    rotate_face_to_match_z_axis,
    rotate_face_to_parallel_x_axis,
)
from tools.big_five.myutils.detect3d import detect_3d_with_quality_assessment
...
class BigFiveVisualModel(object):
    def __init__(
        self, model_path, scale_min=0, scale_max=40, dataset_min=-5, dataset_max=5
    ):
    ...
    def predict_bigfive(
        ...
        try:
            ...
            landmarks_data_list = detect_3d_with_quality_assessment(
                video_fp=video_path,
                max_frame=max_frame,
                max_error=max_error,
